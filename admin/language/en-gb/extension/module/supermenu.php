<?php
// Heading
$_['page_title']       = 'Horizontal Mega Menu'; 
...
$_['text_settings_viewmorename']     = 'View More link Name:  <span class="help">( when displaying limited number of subcategories )</span>';
$_['text_settings_viewallname']      = 'View all Link Name: <span class="help">( when displaying link to top item in dropdown)</span>';
...
$_['text_3dlevellimit']              = 'Subcategories limit: <span class="help">( for the 3rd level of subcategories )</span>';
...
$_['text_settings_fproduct']         = 'Supermenu Featured products';
...
// Entry
$_['entry_type']          = 'Item Type and Style: <br /> <span class="help">Here you select the type of the menu item and its display style.</span>';
...
$_['entry_advanced']      = 'Advanced Settings: <br /> <span class="help">Here you can customize the dropdown with below setings.</span>';
$_['entry_iset']          = 'Item Settings: <br /> <span class="help">Basic settings for the supermenu item.</span>';
