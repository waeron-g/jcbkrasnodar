...
class ControllerExtensionModuleBlogger extends Controller {
	public function index($setting) {
		...
		foreach ($this->model_codezeel_blogger->getBlogsByModule($setting['module_id'], $setting['limit']) as $result) {			
			...
			$data['blogs'][] = array(
				...
				'date_format_month'  => date($this->language->get('date_format_month'), strtotime($result['date_added'])),				
