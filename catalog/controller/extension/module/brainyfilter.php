...
//            }
    ...
    private function _getSettings($layoutId)
    {
        ...
        $settings = $bfSettings['basic'];
        
        $instSettings = $this->config->get('brainyfilter_layout_' . $layoutId);
        if (isset($instSettings['behaviour']['containerSelector'])) {
            $settings['behaviour']['containerSelector'] = $instSettings['behaviour']['containerSelector'];
        }
        if (isset($instSettings['behaviour']['paginatorSelector'])) {
            $settings['behaviour']['paginatorSelector'] = $instSettings['behaviour']['paginatorSelector'];
        }
        if (isset($instSettings['categories'])) {
            $settings['categories'] = $instSettings['categories'];
        }
