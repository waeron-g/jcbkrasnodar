...
class ControllerExtensionModuleSupermenu extends Controller {
	...
	public function index() {
		  		...
		  		if ($item['type'] == 'cat') {
					...
					if ($item['products'] == 'featured') {
			 		...
			 		if ($this->customer->isLogged()) {
			     		$item_url = $this->url->link('account/account', '', true);
				 		$item_name = $this->language->get('text_account');
			 		} else {
			 			$item_url = $this->url->link('account/login', '', true);
			 			$item_name = $this->language->get('text_login');
			 		}
		...
		$data['actiond'] = $this->url->link('account/login', '', true);
		$data['registerd'] = $this->url->link('account/register', '', true);
		$data['forgottend'] = $this->url->link('account/forgotten', '', true);
